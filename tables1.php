...
<body id="page-top">
    ...
    <div class="card-header py-3">
        <h6 class="m-10 font-weight-bold text-primary">DATA CALON SISWA SMK WIKRAMA BOGOR</h6>
    </div>
    <div class="card-body">
        <div class="row">
            <!-- Form Search -->
    ...
    <div class="mb-3">
        ...
        <option value="TJKT">TJKT</option>
            ...
            <a href="tambah.php" class="btn btn-primary ml-5 float-end w-100">
    Add
</a>
        </div>
    </div>
        ...
        <tbody>
            ...
            <?php foreach ($mahasiswa as $siswa): ?>
                <tr>
                    ...
                    <a class="button" href="transfer.php?id=<?= $siswa["id"];?>">lulus</a>
                    <a class="button" href="hapus.php?id=<?= $siswa["id"];?>">DELETE</a>
                    </form>
                </th>
